...
<meta charset="UTF-8">
	...
	$(document).ready(function() {
		function fn_qnaList(){
			location.href = "${context}/work/board/qnaList.do";
		}
		//글 삭제
		function fn_delete(){
...
<div class="container review-box" >
	<div class="d-flex flex-row justify-content-between">
		<div  class="col-xs-6">
	   		<h3>댓글 목록 <span class="badge bg-secondary">${dsComment[0].COMMENT_COUNT}</span></h3>
		</div>
	...
	<div class="row">
		<div class="col-md-12" id="post-review-box" style="display:block;">
            <form id="createComment" accept-charset="UTF-8" action="${context}/work/reply/createComment.do" method="post">
                ...
                <input type="hidden" id="qnaNo" name="qnaNo"  value="${dsQnA.QNA_NO}">
