	...
	<div class="px-5 py-5">
	                     ...
	                     <c:forEach items="${dsQnAList}" var="dsQnAList">
	                      <tr>
	                      	<td class="d-flex flex-row">
	                      		<div class="col-md-8 p-2 px-left-1"><a href ="${context}/work/board/qnaView.do?qnaNo=${dsQnAList.QNA_NO}">${dsQnAList.QNA_TITLE}</a></div>
								<div class="col-md-1 p-2 px-right-1">${dsQnAList.USER_NAME}</div>
		...
		<c:if test="${sessionScope.grade == 'A' || sessionScope.grade == 'M'}">
			<div class="d-flex flex-row-reverse p-2">
				<button type="button" class="btn boardbtn p-2" onclick="qnaWrite()">새 글 쓰기</button>
			</div>
		</c:if>
		<!-- board buttons end -->
