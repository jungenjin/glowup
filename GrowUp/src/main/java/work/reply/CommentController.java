...
public class CommentController {
	...
	@RequestMapping(value="/work/board/retrieveComment.do", method = {RequestMethod.GET})
	public ModelAndView retrieveCommentList(HttpServletRequest request){
		...
		mv.addObject("commentParam", commentParam);
		
		System.out.println("commentParam 출력////////////////////"+commentParam );
		
		mv.addObject("dsComment", dsComment);

		System.out.println("dsComment 출력////////////////////"+dsComment );
		//commentService.retrieveCommentList(commentParam);
